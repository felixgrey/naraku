...
function () {
  ...
  initializer: function initializer() {
    ...
    return function (name, callback) {
      _this23._runnerList.push(name);

      return _this23._dataHub._executor.register(name, callback);
    };
  }
  ...
  initializer: function initializer() {
    ...
    return function (name, callback) {
      return _this24._dataHub._executor.before(name, callback);
    };
  }
  ...
  initializer: function initializer() {
    ...
    return function (name, callback) {
      _this25._dataHub._executor.after(name, callback);
    };
  }
  ...
  initializer: function initializer() {
    ...
    return function (name, callback) {
      ...
      _this26._emitter.on(name, callback);

      return function () {
        _this26._emitter.off(name, callback);
      };
    };
  }
  ...
  initializer: function initializer() {
    ...
    return function (type) {
      ...
      _this27._dataHub.doFetch(type, tempDataName, param, {});

      return new Promise(function (resolve) {
        _this27.once('$fetchEnd:' + tempDataName, function (data) {
          resolve(data);

          _this27._dataHub.delete(tempDataName);
        });
      });
    };
  }
  ...
  initializer: function initializer() {
    ...
    return function (name, callback) {
      ...
      _this28._emitter.once(name, callback);
  ...
  initializer: function initializer() {
    ...
    return function (callback) {
      ...
      var onChange = function onChange() {
        ...
        clearTimeout(_this29._watchTimeoutIndex);
        _this29._watchTimeoutIndex = setTimeout(function () {
          callback();
        }, lagTime);
      };

      _this29[fun]('$dataChange', onChange);

      _this29[fun]('$statusChange', onChange);
  ...
  initializer: function initializer() {
    ...
    return function (name, callback) {
      ...
      if (Array.isArray(name)) {
        ...
        var _this30$_checkReady2 = _this30._checkReady(name),
            ready = _this30$_checkReady2.ready,
            dataList = _this30$_checkReady2.dataList;
        ...
        name.forEach(function (_name) {
          offList.push(_this30[fun](_name, wrapedCallback));
        });
        return function () {
      ...
      return _this30._when(name, callback, _once);
    };
  }
      ...
      var infiniteOnce = function infiniteOnce() {
        ...
        Promise.all(name.map(function (_n) {
          return new Promise(function (r) {
            offList.push(_this31.once(_n, r));
          });
        })).then(function () {
          callback(_this31._checkReady(name).dataList);
          offList = [];
          !stop && infiniteOnce();
        });
      };
  ...
  initializer: function initializer() {
    ...
    return function (name, callback) {
      ...
      var wrapedCallback = function wrapedCallback() {
        ...
        callback(_this32._dataHub.get(name));
      };

      if (_this32._dataHub.status(name) === 'set') {
        wrapedCallback();
      ...
      return _this32[fun](name, wrapedCallback);
    };
  }
})), _class2));
...
var DataHub = (_dec35 = ifInvalid(), _dec36 = ifInvalid(), _dec37 = ifInvalid(false), _dec38 = ifInvalid(true), _dec39 = ifInvalid(false), _dec40 = ifInvalid(false), _dec41 = ifInvalid(false), _dec42 = ifInvalid(false), _dec43 = ifInvalid(), _dec44 = ifInvalid(), _dec45 = ifInvalid(), _dec46 = ifInvalid(), _dec47 = ifInvalid(), _dec48 = ifInvalid(), _dec49 = ifInvalid(), _dec50 = ifInvalid(), _dec51 = ifInvalid(), _dec52 = ifInvalid(), _dec53 = ifInvalid(), _dec54 = ifInvalid(), _dec55 = ifInvalid(), _dec56 = ifInvalid(), _dec57 = ifInvalid(), (_class4 = (_temp2 =
/*#__PURE__*/
function () {
  function DataHub() {
    var _this33 = this;
    ...
    this.addBeforeFetcher = function (callback) {
      _this33._controller.after('beforeFetcher', callback);
    };

    this.addAfterFetcher = function (callback) {
      _this33._controller.after('afterFetcher', callback);
    };
  ...
  _createClass(DataHub, [{
    ...
    value: function loading(list) {
      ...
      return [].concat(list).reduce(function (a, b) {
        return a || _this36.status(b) === 'loading';
      }, false);
    }
  }, {
    key: "error",
    value: function error(list) {
      ...
      return [].concat(list).reduce(function (a, b) {
        return a || _this37.status(b) === 'error';
      }, false);
    }
  }, {
    key: "locked",
    value: function locked(list) {
      ...
      return [].concat(list).reduce(function (a, b) {
        return a || _this38.status(b) === 'locked';
      }, false);
    }
  }, {
    key: "lock",
    value: function lock(names) {
      ...
      names.forEach(function (name) {
        if (_this39.status(name) !== 'locked') {
          oldStatus.push({
            name: name,
            old: _this39.status(name)
          });

          _this39.status(name, 'locked');
        }
      });
      return function () {
        if (!unlock) {
    ...
    value: function submit(name) {
      ...
      var afterSubmit = function afterSubmit(data) {
        ...
        [].concat(refresh).forEach(function (refreshName) {
          _this40.refresh(refreshName);
        });
      };

      return new Promise(function (resolve, reject) {
        _this40._controller.once('$fetchEnd:' + name, function (resultData) {
          if (_this40.status(name) === 'error') {
            _this40.set(name, []);
    ...
    value: function doFetch(action, name) {
      ...
      this._lagFetchTimeoutIndex[name] = setTimeout(function () {
        ...
        if (_this42.status(name) === 'loading') {
          (0, _Utils.errorLog)("".concat(name, " can not be fetched when loading"));
          return;
        }

        _this42.status(name, 'loading');

        param = (0, _Utils.snapshot)(param);
        Promise.resolve(param).then(function (param) {
          return _this42._controller.run('beforeFetcher', param, name, _this42);
        }).then(function (param) {
          return DataHub.dh._controller.run('beforeFetcher', param, name, _this42);
        }).then(function (newParam) {
          if (newParam === _Utils.stopRun || _this42._invalid) {
            return Promise.reject(_Utils.stopRun);
          }

          var submitData = (0, _Utils.snapshot)(_this42.get(name));
          ...
          return DataHub.dh._controller.run('afterFetcher', result, name, _this42);
        }).then(function (result2) {
          return _this42._controller.run('afterFetcher', result2, name, _this42);
          ...
          _this42.set(name, newResult);

          _this42.emit('$fetchEnd', newResult);

          _this42.emit('$fetchEnd:' + name, newResult);
        }).catch(function (e) {
          if (_this42._invalid) {
            return;
          }
          ...
          if (e === _Utils.stopRun) {
            _this42.status(name, 'set');
          } else {
            (0, _Utils.errorLog)(e);

            if (!_this42._data[name]) {
              _this42.set(name, []);
            }

            _this42.status(name, 'error');

            _this42.emit('$error', e);

            _this42.emit('$error:' + name, e);

            _this42.emit('$fetchEnd', e);

            _this42.emit('$fetchEnd:' + name, e);
          }
        });
      }, lagTime);
    }
  ...
  return DataHub;
}(), _temp2), (_applyDecoratedDescriptor(_class4.prototype, "status", [_dec35], Object.getOwnPropertyDescriptor(_class4.prototype, "status"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "set", [_dec36], Object.getOwnPropertyDescriptor(_class4.prototype, "set"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "hasData", [_dec37], Object.getOwnPropertyDescriptor(_class4.prototype, "hasData"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "blank", [_dec38], Object.getOwnPropertyDescriptor(_class4.prototype, "blank"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "ready", [_dec39], Object.getOwnPropertyDescriptor(_class4.prototype, "ready"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "loading", [_dec40], Object.getOwnPropertyDescriptor(_class4.prototype, "loading"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "error", [_dec41], Object.getOwnPropertyDescriptor(_class4.prototype, "error"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "locked", [_dec42], Object.getOwnPropertyDescriptor(_class4.prototype, "locked"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "lock", [_dec43], Object.getOwnPropertyDescriptor(_class4.prototype, "lock"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "submit", [_dec44], Object.getOwnPropertyDescriptor(_class4.prototype, "submit"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "emit", [_dec45], Object.getOwnPropertyDescriptor(_class4.prototype, "emit"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "bind", [_dec46], Object.getOwnPropertyDescriptor(_class4.prototype, "bind"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "get", [_dec47], Object.getOwnPropertyDescriptor(_class4.prototype, "get"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "first", [_dec48], Object.getOwnPropertyDescriptor(_class4.prototype, "first"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "assign0", [_dec49], Object.getOwnPropertyDescriptor(_class4.prototype, "assign0"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "snapshot", [_dec50], Object.getOwnPropertyDescriptor(_class4.prototype, "snapshot"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "reset", [_dec51], Object.getOwnPropertyDescriptor(_class4.prototype, "reset"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "clear", [_dec52], Object.getOwnPropertyDescriptor(_class4.prototype, "clear"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "delete", [_dec53], Object.getOwnPropertyDescriptor(_class4.prototype, "delete"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "refresh", [_dec54], Object.getOwnPropertyDescriptor(_class4.prototype, "refresh"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "doFetch", [_dec55], Object.getOwnPropertyDescriptor(_class4.prototype, "doFetch"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "controller", [_dec56], Object.getOwnPropertyDescriptor(_class4.prototype, "controller"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "destroy", [_dec57], Object.getOwnPropertyDescriptor(_class4.prototype, "destroy"), _class4.prototype)), _class4));

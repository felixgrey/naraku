...
var DataHub = (_dec35 = ifInvalid(), _dec36 = ifInvalid(), _dec37 = ifInvalid(false), _dec38 = ifInvalid(false), _dec39 = ifInvalid(false), _dec40 = ifInvalid(false), _dec41 = ifInvalid(), _dec42 = ifInvalid(), _dec43 = ifInvalid(), _dec44 = ifInvalid(), _dec45 = ifInvalid(), _dec46 = ifInvalid(), _dec47 = ifInvalid(), _dec48 = ifInvalid(), _dec49 = ifInvalid(), _dec50 = ifInvalid(), _dec51 = ifInvalid(), _dec52 = ifInvalid(), _dec53 = ifInvalid(), _dec54 = ifInvalid(), _dec55 = ifInvalid(), (_class4 = (_temp2 =
/*#__PURE__*/
function () {
  function DataHub() {
  ...
  _createClass(DataHub, [{
    ...
    value: function loading(list) {
      ...
      return [].concat(list).reduce(function (a, b) {
        return a || _this34.status(b) === 'loading';
      }, false);
    }
  }, {
    key: "error",
    value: function error(list) {
      ...
      return [].concat(list).reduce(function (a, b) {
        return a || _this35.status(b) === 'error';
      }, false);
    }
  }, {
    key: "hasData",
    ...
    value: function lock(names) {
      ...
      names.forEach(function (name) {
        if (_this36.status(name) !== 'locked') {
          oldStatus.push({
            name: name,
            old: _this36.status(name)
          });

          _this36.status(name, 'locked');
        }
      });
      return function () {
        if (!unlock) {
    ...
    value: function submit(name) {
      ...
      var afterSubmit = function afterSubmit(data) {
        ...
        [].concat(refresh).forEach(function (refreshName) {
          _this37.refresh(refreshName);
        });
      };

      return new Promise(function (resolve, reject) {
        _this37._controller.once('$fetchEnd:' + name, function (resultData) {
          if (_this37.status(name) === 'error') {
            _this37.set(name, []);
    ...
    value: function doFetch(action, name) {
      ...
      this._lagFetchTimeoutIndex[name] = setTimeout(function () {
        ...
        if (_this38.status(name) === 'loading') {
          (0, _Utils.errorLog)("".concat(name, " can not be fetched when loading"));
          return;
        }

        _this38.status(name, 'loading');

        delete _this38._fetchParam[name];
        param = (0, _Utils.snapshot)(param);
        Promise.resolve(param).then(function (param) {
          return _this38._controller.run('beforeFetcher', param, name, _this38);
        }).then(function (param) {
          return DataHub.dh._controller.run('beforeFetcher', param, name, _this38);
        }).then(function (newParam) {
          if (newParam === _Utils.stopRun || _this38._invalid) {
            return Promise.reject(_Utils.stopRun);
          }

          var submitData = (0, _Utils.snapshot)(_this38.get(name));
          ...
          return DataHub.dh._controller.run('afterFetcher', result, name, _this38);
        }).then(function (result2) {
          return _this38._controller.run('afterFetcher', result2, name, _this38);
          ...
          _this38.set(name, newResult);

          _this38.emit('$fetchEnd', newResult);

          _this38.emit('$fetchEnd:' + name, newResult);
        }).catch(function (e) {
          if (_this38._invalid) {
            return;
          }
          ...
          if (e === _Utils.stopRun) {
            _this38.status(name, 'set');
          } else {
            (0, _Utils.errorLog)(e);

            if (!_this38._data[name]) {
              _this38.set(name, []);
            }

            _this38.status(name, 'error');

            _this38.emit('$error', e);

            _this38.emit('$error:' + name, e);

            _this38.emit('$fetchEnd', e);

            _this38.emit('$fetchEnd:' + name, e);
          }
        });
      }, lagTime);
    }
  ...
  return DataHub;
}(), _temp2), (_applyDecoratedDescriptor(_class4.prototype, "status", [_dec35], Object.getOwnPropertyDescriptor(_class4.prototype, "status"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "set", [_dec36], Object.getOwnPropertyDescriptor(_class4.prototype, "set"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "ready", [_dec37], Object.getOwnPropertyDescriptor(_class4.prototype, "ready"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "loading", [_dec38], Object.getOwnPropertyDescriptor(_class4.prototype, "loading"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "error", [_dec39], Object.getOwnPropertyDescriptor(_class4.prototype, "error"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "hasData", [_dec40], Object.getOwnPropertyDescriptor(_class4.prototype, "hasData"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "lock", [_dec41], Object.getOwnPropertyDescriptor(_class4.prototype, "lock"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "submit", [_dec42], Object.getOwnPropertyDescriptor(_class4.prototype, "submit"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "emit", [_dec43], Object.getOwnPropertyDescriptor(_class4.prototype, "emit"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "bind", [_dec44], Object.getOwnPropertyDescriptor(_class4.prototype, "bind"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "get", [_dec45], Object.getOwnPropertyDescriptor(_class4.prototype, "get"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "first", [_dec46], Object.getOwnPropertyDescriptor(_class4.prototype, "first"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "assign0", [_dec47], Object.getOwnPropertyDescriptor(_class4.prototype, "assign0"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "snapshot", [_dec48], Object.getOwnPropertyDescriptor(_class4.prototype, "snapshot"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "reset", [_dec49], Object.getOwnPropertyDescriptor(_class4.prototype, "reset"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "clear", [_dec50], Object.getOwnPropertyDescriptor(_class4.prototype, "clear"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "delete", [_dec51], Object.getOwnPropertyDescriptor(_class4.prototype, "delete"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "refresh", [_dec52], Object.getOwnPropertyDescriptor(_class4.prototype, "refresh"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "doFetch", [_dec53], Object.getOwnPropertyDescriptor(_class4.prototype, "doFetch"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "controller", [_dec54], Object.getOwnPropertyDescriptor(_class4.prototype, "controller"), _class4.prototype), _applyDecoratedDescriptor(_class4.prototype, "destroy", [_dec55], Object.getOwnPropertyDescriptor(_class4.prototype, "destroy"), _class4.prototype)), _class4));

...
function getObjValue() {
  ...
  var blank = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

  var _deep = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  ...
  if (typeof field === 'string') {
    field = field.split('.').filter(function (a) {
      return !(noValue(a) || a.trim() === '');
    });
  }
  ...
  var theField = field.shift().trim();
  var value = obj[theField];

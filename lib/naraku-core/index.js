...
var _Declare = require("./Declare.js");
...
function (_EventEmitter) {
  _inherits(NodeEvent, _EventEmitter);
  ...
  function NodeEvent() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(NodeEvent)).call.apply(_getPrototypeOf2, [this].concat(args)));
